...
{
    resize(850, 550);
    setWindowTitle(tr("Platonic") + " - " + tr("Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
   ...
   // tabGroup->addAction(miningAction);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Platonic address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Platonic"), this);
    aboutAction->setToolTip(tr("Show information about Platonic"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Platonic"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &Platonic"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Platonic window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Platonic client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Platonic client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Platonic"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Platonic network", "", count));
}
...
//{
 ...
 //       labelMiningIcon->setToolTip(tr("Mining Platonic at %1 hashes per second").arg(hashrate));
 //   }
 //   else
 //   {
  //      labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
//        labelMiningIcon->setToolTip(tr("Not mining Platonic"));
//    }
//}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Platonic address or malformed URI parameters."));
    }
