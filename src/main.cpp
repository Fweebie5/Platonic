...
int64 nChainStartTime = 1419980171;
...
const string strMessageMagic = "Platonic Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Platonic
    bool fStrictPayToScriptHash = true; // Always active in Platonic
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Platonic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "December 31, 2014, RippleLite Comes To Existence 1419980171";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1419980171;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1382434;
        ...
        assert(block.hashMerkleRoot == uint256("a99d78e8b5c375d971a5443a04aa0f37a08dc2a909c2bb5f787a420a1ca1d8ee"));
